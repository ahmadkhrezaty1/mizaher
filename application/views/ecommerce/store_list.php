              ...
              <div class="col-4 p-0">
                <div class="card-header-action dropleft float-right">
                  ...
                  <ul class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                    ...
                    <li><?php echo '<a class="dropdown-item" data-toggle="tooltip" title="'.$this->lang->line('Dashboard').'" href='.base_url('ecommerce').'><i class="fas fa-tachometer-alt"></i> &nbsp; '.$this->lang->line("Dashboard").'</a>';?></li>
                    <li><?php echo '<a class="dropdown-item iframed" data-toggle="tooltip" title="'.$this->lang->line('Products').'" href='.base_url('ecommerce/product_list').'><i class="fas fa-box-open"></i> &nbsp; '.$this->lang->line("Products").'</a>';?></li>
                    <li><?php echo '<a class="dropdown-item iframed" data-toggle="tooltip" title="'.$this->lang->line('Coupons').'" href='.base_url('ecommerce/coupon_list').'><i class="fas fa-gifts"></i> &nbsp; '.$this->lang->line("Coupons").'</a>';?></li>
                    <li><?php echo '<a class="dropdown-item iframed" data-toggle="tooltip" title="'.$this->lang->line('Categories').'" href='.base_url('ecommerce/category_list').'><i class="fas fa-columns"></i> &nbsp; '.$this->lang->line("Categories").'</a>';?></li>
                    <li><?php echo '<a class="dropdown-item iframed" data-toggle="tooltip" title="'.$this->lang->line('Attributes').'" href='.base_url('ecommerce/attribute_list').'><i class="fas fa-palette"></i> &nbsp; '.$this->lang->line("Attributes").'</a>';?></li>
                    <div class="dropdown-divider"></div>
                    <li><?php echo '<a class="dropdown-item iframed" data-toggle="tooltip" title="'.$this->lang->line('Orders').'" href='.base_url('ecommerce/order_list').'><i class="fas fa-cart-plus"></i> &nbsp; '.$this->lang->line("Orders").'</a>';?></li>
                    <li><?php echo '<a class="dropdown-item iframed" href='.base_url('ecommerce/copy_url/'.$this->session->userdata("ecommerce_selected_store")).' data-toggle="tooltip" title="'.$this->lang->line('Copy URL').'"><i class="fas fa-copy"></i> &nbsp; '.$this->lang->line("Copy URL").'</a>';?></li>
                    <li><?php echo '<a class="dropdown-item" href="'.base_url('ecommerce/store/'.$current_store_data['store_unique_id']).'" target="_BLANK" data-toggle="tooltip" title="'.$this->lang->line('Store Page').'"><i class="fas fa-newspaper"></i> &nbsp; '.$this->lang->line("Visit Store").'</a>';?></li>
                    <!-- <li><?php echo '<a class="dropdown-item reminder_report" href="" data-toggle="tooltip" title="'.$this->lang->line('Reminder Report').'" campaign_id='.$current_store_data['id'].'><i class="fas fa-eye "></i> &nbsp; '.$this->lang->line("Reminder Report").'</a>';?></li> -->
                    <div class="dropdown-divider"></div>
                    <li><?php echo '<a class="dropdown-item iframed" href="'.base_url()."ecommerce/edit_store/".$current_store_data['id'].'" data-toggle="tooltip" title="'.$this->lang->line('Edit Store').'" campaign_id='.$current_store_data['id'].'><i class="fas fa-edit"></i> &nbsp; '.$this->lang->line("Edit Store").'</a>';?></li>
                    <li><?php echo '<a class="dropdown-item delete_campaign text-danger" data-toggle="tooltip" href="#" title="'.$this->lang->line('Delete Store').'" data-toggle="tooltip" campaign_id='.$current_store_data['id'].'><i class="fas fa-trash-alt"></i> &nbsp; '.$this->lang->line("Delete Store").'</a>'; ?></li>
                  </ul>
                </div> 
              </div>
            </div>
