...
$store_address = $webhook_data_final["store_address"]."<br>".$webhook_data_final["store_state"]."<br>".$store_country." ".$webhook_data_final["store_zip"];
...
$apply_coupon = 
'
<div class="section-title">'.$this->lang->line("Apply Coupon").'</div>
  ...
  <div class="section-body">
    ...
    <div class="invoice" style="border:1px solid #dee2e6;padding:40px 25px">
      ...
      <div class="invoice-print"> 
        <div class="row">
          <div class="col-md-12">
            <div class="section-title mt-0"><?php echo $this->lang->line("Checkout Summary"); ?><span class="float-right"><?php echo date("jS M,Y"); ?></span></div>
            <?php echo $table_data;?>
            <div class="row">
              ...
              <div class="col-12 col-md-6">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <?php 
                      $default_country = isset($wc_buyer_location['country']) ? $wc_buyer_location['country'] : "";
                      $country_names[''] =  $this->lang->line("Select Country");
                      ?>
                      <?php echo form_dropdown('country', $country_names,$default_country,"id='country' class='form-control select2' style='width:65%'"); ?>
                    </div>
                  </div> 
              </div>
              <div class="col-12 col-md-6">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      $country_names[''] =  $this->lang->line("Select Country");
                      ?>
                      <?php echo form_dropdown('buyer_country', $country_names,$default_country,"id='buyer_country' class='form-control select2' style='width:65%'"); ?>
                    </div>
                  </div> 
              </div>
...
<style type="text/css">
  ...
  #payment_options button:not(.stripe-button-el){
    font-size:14px;
    font-weight:bold;
