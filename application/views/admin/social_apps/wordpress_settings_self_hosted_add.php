	...
	<div class="section-body">
		<div class="row">
			<div class="col-12">
				...
				<form action="<?php echo base_url("social_apps/add_wordpress_settings_self_hosted"); ?>" method="POST">
					<div class="card">
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="form-group">
										<label for="domain_name"><i class="fas fa-file-signature"></i> <?php echo $this->lang->line("Domain Name");?></label>
										...
										<input id="domain_name" name="domain_name" value="<?php echo set_value('domain_name'); ?>" class="form-control" type="text">  
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<input id="user_key" name="user_key" value="<?php echo set_value('user_key'); ?>" class="form-control" type="text">  
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<input id="authentication_key" name="authentication_key" value="<?php echo set_value('authentication_key', $auth_key); ?>" class="form-control" type="text">  
