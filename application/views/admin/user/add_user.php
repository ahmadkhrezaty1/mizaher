          ...
          <div class="card-body">
            ...
            <div class="row" id="hidden_manager">
              <div class="col-md-6">   
                <div class="col-6 col-md-4">
                  <label class="custom-switch">
                    <input type="radio" name="manager_type" id="Manager_1" value="Manager 1" class="manager_type custom-switch-input">
                    <span class="custom-switch-indicator"></span>
                ...
                <div class="col-6 col-md-4">
                  <label class="custom-switch">
                    <input type="radio" name="manager_type" id="Manager_3" value="Manager 3" class="manager_type custom-switch-input">
                    <span class="custom-switch-indicator"></span>
