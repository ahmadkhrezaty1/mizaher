...
class Member extends Home
{
    ...
    */
    ...
    public function user_added_email_to_admin($user_name){
        if(!is_manager()){
        ...
        $message = "<p>".$this->lang->line("To show all users you can go to ").$details_url."</p>";
    ...
    public function user_edited_email_to_admin($user_name){
        if(!is_manager()){
            redirect('home/access_forbidden', 'location');
        }
        $manager_name = $this->session->userdata('username');
        ...
        if($_POST)
        {
            ...
            {               
                ...
                if($this->basic->update_data('users',array("id"=>$id),$data)) {
                    $this->user_edited_email_to_admin($data['name']);
        ...
        if($_POST)
        {
            ...
            {      
                ...
                if($this->basic->insert_data('users',$data)) {
                    $this->user_added_email_to_admin($data['name']);
                    $this->session->set_flashdata('success_message',1);   
                }
                else $this->session->set_flashdata('error_message',1);     
